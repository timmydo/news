...
impl App {
    ...
    fn render_article_view(&self, width: usize, height: usize, lines: &mut Vec<String>) {
        ...
        // Strip reference link definitions generated by html2text (e.g. "[1]: https://...")
...
/// generated by html2text, so we can strip them from rendered output.
fn is_reference_link_def(line: &str) -> bool {
    ...
    if let Some(bracket_end) = trimmed.find("]: ") {
        ...
        // Reference labels are typically numeric (from html2text)
